...
\newcommand{\pairs}{\ensuremath{\text{pairs}}\xspace}
\newcommand{\pairings}{\ensuremath{\text{pairings}}\xspace}
\newcommand{\unpaired}{\ensuremath{\text{unpaired}}\xspace}
...
\newcommand{\candidates}{\ensuremath{\mathit{candidates}}\xspace}
...
\newcommand{\subscript}[2]{_{{#1}, {#2}}}
\newcommand{\Qf}[2]{\ensuremath{Q\subscript{{#1}}{{#2}}}\xspace}
\newcommand{\Qhat}{\ensuremath{\widehat{Q}}\xspace}
\newcommand{\Qhatf}[2]{\ensuremath{\Qhat\subscript{{#1}}{{#2}}}\xspace}
...
\newcommand{\pop}{\ensuremath{\text{\sc pop}}\xspace}
\newcommand{\popline}{\ensuremath{\!\!\!\!\stackrel{\pop}{\longrightarrow}\!\!\!\!}\xspace}
\newcommand{\nskip}{\ensuremath{\text{\sc skip}}\xspace}
...
\newcommand{\linearpartitionc}{{LinearPartition-C}\xspace}
\newcommand{\linearpartitionv}{{LinearPartition-V}\xspace}
...
\newcommand{\viennarnaplfold}{{Vienna RNAplfold}\xspace}
...
\newcommand{\linear}{\ensuremath{\mathrm{linear}}\xspace}
\newcommand{\vienna}{\ensuremath{\mathrm{vienna}}\xspace}
\newcommand{\ensenergy}{\ensuremath{\Delta G^\circ_\text{ensemble}}\xspace}
\newcommand{\ensenergyvienna}{\ensuremath{\Delta G^{\circ\ \text{vienna}}_\text{ensemble}}\xspace}
\newcommand{\ensenergylinear}{\ensuremath{\Delta G^{\circ\ \text{linear}}_\text{ensemble}}\xspace}
\newcommand{\ddg}{\ensuremath{\Delta\Delta G^{\circ}_\text{ensemble}}\xspace}

\newcommand{\RMSD}{\ensuremath{\text{\sc rmsd}}\xspace}

\newcommand{\mtwo}[1]{\multirow{2}{*}{{#1}}}
\newcommand{\mthree}[1]{\multirow{2}{*}{{#1}}}

\newcommand{\threshknot}{\ensuremath{\text{ThreshKnot}}\xspace}
\newcommand{\probknot}{\ensuremath{\text{ProbKnot}}\xspace}
\newcommand{\ipknot}{\ensuremath{\text{IPknot}}\xspace}
\newcommand{\dotknot}{\ensuremath{\text{DotKnot}}\xspace}
\newcommand{\centroidfold}{\ensuremath{\text{CentroidFold}}\xspace}
